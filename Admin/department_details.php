...
<body>
     ...
     <!--2nd column start-->
         ...
         <!--nav bar start-->
            <nav class="navbar navbar-expand-sm bg-dark ">
              <a class="navbar-brand text-white">Department Details</a>
         ...
         <!-- 2nd nav bar start-->
                 ...
                 <nav aria-label="breadcrumb ">
                      ...
                      <ol class="breadcrumb arr-right bg-secondary-50 ">
                        ...
                        <li class="breadcrumb-item "><a href="" class="text-dark">Department</a></li>
                  ...
                  <div class="col-sm-8">
                      ...
                      <div class="card-header" style="height:100px">              
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Department" name="departmentname" id="Department"><br>
 ...
 <div class="card">
      ...
      <div class="card-body">
      <form action="alldelet_dept.php" method="post">
        <table class="table">
        ...
        <tbody>
        <?php
              $cmd="select * from department_details order by Department_Name asc";
              $data=$conn->query($cmd);
              $slno=1;
              foreach($data as $var)
             {
              ?>
                  <tr>
                        <td><input type="checkbox" name="chkUser[]" id="chkUser" value="<?php echo $var['Department_Id'] ?>"/></td>
                        <td ><?php echo $slno++; ?></td>
                        <td ><?php echo $var['Department_Name']?></td>
                        <td ><?php echo $var['Status']?></td>
                        <td >
                              
                              <a href="edit_department.php?id=<?php echo $var['Department_Id'] ?>"><i class='fas fa-edit'></i></a>
                              <a href="deletedepartment.php?id=<?php echo $var['Department_Id'] ?>"><i class='fas fa-trash'></i></a>
