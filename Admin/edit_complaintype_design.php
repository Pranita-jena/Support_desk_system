    ...
    <!-- 1st column-->
     ...
     <!--2nd column start-->
      ...
      <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>" /> 
                           <?php
								$cmd="select * from complaintype_details where complain_id=".$_GET['id'];
								$data=$conn->query($cmd);
								foreach($data as $var)
								{
							?>
                  ...
                  <div class="col-xs-6">
                      ...
                      <div class="card-header">              
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="complaintype" placeholder="" id="complain" value="<?php echo $var['complain_type'] ?>" >
