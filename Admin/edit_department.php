     ...
     <!--2nd column start-->
         ...
         <!--nav bar start-->
            <nav class="navbar navbar-expand-sm bg-dark ">
              <a class="navbar-brand text-white" href="#">Department Details</a>
        ...
        <!-- 2nd nav bar start-->
                 ...
                 <nav aria-label="breadcrumb ">
                      ...
                      <ol class="breadcrumb arr-right bg-secondary-50 ">
                        ...
                        <li class="breadcrumb-item "><a href="#" class="text-dark">Edit Department</a></li>
      ...
      <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>" /> 
                           <?php
								$cmd="select * from department_details where Department_Id=".$_GET['id'];
								$data=$conn->query($cmd);
								foreach($data as $var)
								{
							?>
                  ...
                  <div class="col-xs-6">
                      ...
                      <div class="card-header">              
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="departmentname" placeholder="" id="Department" value="<?php echo $var['Department_Name'] ?>" >
                          ...
                          <div class="form-group">
                            <label for="dept"><strong>STATUS</strong></label><br>
                                      ...
                                      <select name="status" id="status">
                                                ...
                                                <option value="Active" <?php if($var['Status']=="Active") echo "selected=\"selected\"" ?>>Active</option>
                                                <option value="InActive" <?php if($var['Status']=="InActive") echo "selected=\"selected\"" ?>>InActive</option>
                                     </select> 
                                     <?php } ?>         
                          </div>
                      </div>
