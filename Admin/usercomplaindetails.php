         ...
         <div class="container"> 
            ...
            <div class="card">
              <div class="card-header">
                     ...
                     <a href="addnewcomplain_design.php" style="float:right"><button> ADD NEW COMPLAIN</button></a>
              </div>
              <div class="card-body">
              <form action="alldelete_usercomplain_code.php" method="post">
                 <table class="table">
                     <thead class="thead-light">
                          <tr>
                                <th><input type="checkbox" name="checkall" va /></th>
                                <th>SL No</th>
                                <th>Dept Name</th>
                                <th>Emp Name</th>
                                <th>Complain Type</th>
                    ...
                    <tbody>
						<?php
							  ...
							  ." inner join it_team_details on it_team_details.IT_Team_M_ID = employee_complain_details.IT_Team_M_ID  order by emp_complain_id asc " ; 
                              ...
                              ?>
                                  <tr>
                                      <?php if($var['complain_status']=='Pending') { ?>
                                        <td><input type="checkbox" name="chkUser[]" id="chkUser" value="<?php echo $var['emp_complain_id'] ?>"/></td>
                                        <td ><?php echo $slno++; ?></td>
                                        ...
                                        <td >
                                              ...
                                              <a href="editemployeecomplaindetails.php?id=<?php echo $var['emp_complain_id'] ?>"><i class='fas fa-edit'></i></a>
                                              <a href="deletitteammember_code.php?id=<?php echo $var['emp_complain_id'] ?>"><i class='fas fa-trash'></i></a>
                                            
                                        </td>
                                    <?php  } elseif($var['complain_status']=='Resolve') { ?>
                                    
                                       <td style="background-color:#99FF00"><input type="checkbox" name="chkUser[]" id="chkUser" value="<?php echo $var['emp_complain_id']                                                                                                                                             ?>"/>
                                       </td>
                                       ...
                                       <td style="background-color:#99FF00"><?php echo $var['IT_Team_M_Name']?></td>
                                       ...
                                       <td style="background-color:#99FF00">
                                          <a href="#"></a>
                                          <a href="deletecomplaindetails_code.php?id=<?php echo $var['emp_complain_id'] ?>"><i class='fas fa-trash'></i></a>
                                       </td>  
                                  </tr>
                                  <?php } ?>
                    </tbody>
