                                          ...
                                          <div class="col-sm-8">
                                              <div class="card-header" style="height:100px">              
                                                  <div class="form-group" >
                                                        ...
                                                        <input type="password" class="form-control" name="oldpwd" required><br>
                                          ...
                                          <div class="col-sm-8">
                                              <div class="card-header" style="height:100px">              
                                                  <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" name="newpwd" id="pwd" required><br>
                                                  </div>
                                              </div>
                                          </div>
                                     </div>
                                          ...
                                          <div class="col-sm-8">
                                              <div class="card-header" style="height:100px">              
                                                  <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" name="" id="conpwd" required><br>
                                                  </div>
                                              </div>
                                          </div>
                                     </div>
